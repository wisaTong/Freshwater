...
export default class LoginPage extends React.Component {
  ...
  handleKeyPress = (event) => {
    if(event.key === 'Enter' && this.state.username.trim() !== ''){
      ...
      ReactDOM.render(<PublicRoom username={this.state.username}/>, document.getElementById('root'));
    }
  }
      ...
      <div className="container">
        ...
        <div className="rightpane">
          ...
          <div className="send-name">
            {" "}
            <input placeholder="Enter your name" type="text" value={this.state.username} onChange={this.handleChange} onKeyPress={this.handleKeyPress}/>{" "}
          </div>
          <p> or </p>
          <Link to="/public-room">
